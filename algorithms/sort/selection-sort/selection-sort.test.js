...
describe('selection sort', () => {
    it('should be [4,7,9,10,12,20]', () => {
        expect(selectionSort([4,20,12,10,7,9])).toEqual([4,7,9,10,12,20]);
    });
    it('should be [-10,0,4,7]', () => {
        expect(selectionSort([0,-10,7,4])).toEqual([-10,0,4,7]);
    });
    it('should be [1,2,3]', () => {
    ...
    it('should be sorted by name', () => {
        ...
        expect(selectionSort(kitties, strComp)).toEqual(result)
    });
    it('should be sorted by oldest to youngest', () => {
        ...
        expect(selectionSort(data, ageComp)).toEqual(result);
    });
});